...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-50 mt-6 md:mt-8">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    placeholder="Ex. ayomidelagb@gmail.com"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                  />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      placeholder="Ex. Inquiry about products"
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                    />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <textarea
                      ...
                      required
                      rows={6}
                      placeholder="Ex. I would like to know more about..."
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                    />
                </div>
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-[#007539] hover:bg-[#005a2a] text-white py-3 rounded-lg font-semibold transition-colors disabled:opacity-50"
                >
            ...
            <div>
              <div className="bg-[#007539] rounded-2xl shadow-lg p-8 text-white">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-green-100 mb-2">Phone: 08169456059</p>
                    <p className="text-green-100">Email: faithoked@gmail.com</p>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold mb-3">Opening Hours</h3>
                    <p className="text-green-100 mb-1">Monday to Saturday: 08:00 AM - 09:00 PM</p>
                    <p className="text-green-100">Sunday 12:00PM - 09:00PM</p>
                  </div>
                  <div>
      ...
      {/* Map Section */}
      <section className="py-16 bg-white mt-6 md:mt-8">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-4 md:p-8 border border-gray-100">
              ...
              <div className="rounded-lg overflow-hidden h-96">
                <iframe
                  src="https://www.google.com/maps?q=Zartech,+Transformer,+Oke-Alaro+Street,+Extension,+Oluyole,+Ibadan+200261,+Nigeria&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Jacinth Pharmacy Location - Zartech, Transformer, Oke-Alaro Street, Extension, Oluyole, Ibadan 200261, Nigeria"
                ></iframe>
              </div>
